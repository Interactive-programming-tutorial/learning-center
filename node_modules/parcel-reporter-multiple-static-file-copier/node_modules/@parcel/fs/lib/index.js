...
function $7250854f629b7e00$var$publishQueue(context, queue1) {
...
function $7250854f629b7e00$var$patch(fs1) {
    // Everything that references the open() function needs to be in here
    $14ed6d859fc43bf5$exports(fs1);
    fs1.gracefulify = $7250854f629b7e00$var$patch;
    ...
    function go$readdir(args) {
        return fs$readdir.apply(fs1, args);
    }
    if (process.version.substr(0, 4) === "v0.8") {
        var legStreams = $ec8337b8453e4d66$exports(fs1);
...
function $48fc3d56c5dfadb2$var$ncp(source1, dest, options, callback) {
    ...
    function isWritable(path1, done) {
        $ki5hV$fs.lstat(path1, function(err) {
            if (err) {
...
$46772b835b3d1aed$exports = JSON.parse('{"name":"@parcel/fs","version":"2.0.0-nightly.1136+a9193ce0b","description":"Blazing fast, zero configuration web application bundler","license":"MIT","publishConfig":{"access":"public"},"funding":{"type":"opencollective","url":"https://opencollective.com/parcel"},"repository":{"type":"git","url":"https://github.com/parcel-bundler/parcel.git"},"main":"lib/index.js","source":"src/index.js","types":"index.d.ts","engines":{"node":">= 12.0.0"},"targets":{"types":false,"main":{"includeNodeModules":{"@parcel/core":false,"@parcel/fs-search":false,"@parcel/types":false,"@parcel/utils":false,"@parcel/watcher":false,"@parcel/workers":false}},"browser":{"includeNodeModules":{"@parcel/core":false,"@parcel/fs-search":false,"@parcel/types":false,"@parcel/utils":false,"@parcel/watcher":false,"@parcel/workers":false}}},"scripts":{"build-ts":"mkdir -p lib && flow-to-ts src/types.js > lib/types.d.ts","check-ts":"tsc --noEmit index.d.ts"},"dependencies":{"@parcel/fs-search":"2.6.3-nightly.2759+a9193ce0b","@parcel/types":"2.0.0-nightly.1136+a9193ce0b","@parcel/utils":"2.0.0-nightly.1136+a9193ce0b","@parcel/watcher":"^2.0.0","@parcel/workers":"2.0.0-nightly.1136+a9193ce0b"},"devDependencies":{"graceful-fs":"^4.2.4","ncp":"^2.0.0","nullthrows":"^1.1.1","utility-types":"^3.10.0"},"peerDependencies":{"@parcel/core":"2.0.0-nightly.1134+a9193ce0b"},"browser":{"@parcel/fs":"./lib/browser.js","./src/NodeFS.js":"./src/NodeFS.browser.js"},"gitHead":"a9193ce0b19e93415f264b3295ceee093ddeb8c7"}');
    ...
    createWriteStream(filePath, options) {
            ...
            if (!failed) try {
                ...
                if (process.platform === "win32" && e.syscall && e.syscall === "rename" && e.code && e.code === "EPERM") {
                    let [hashTmp, hashTarget] = await Promise.all([
                        (0, $ki5hV$parcelutils.hashStream)(writeStream.__atomicTmp),
                        (0, $ki5hV$parcelutils.hashStream)(writeStream.__atomicTarget)
                    ]);
        ...
        let writeStream = (0, (/*@__PURE__*/$parcel$interopDefault($7250854f629b7e00$exports))).createWriteStream(tmpFilePath, {
            ...
            fs: {
                ...
                close: (fd, cb)=>{
                    (0, (/*@__PURE__*/$parcel$interopDefault($7250854f629b7e00$exports))).close(fd, (err1)=>{
                        if (err1) cb(err1);
...
class $86a3ba4eb3a17970$export$3048eb7ec07c2c4e {
    ...
    async symlink(target, path1) {
        target = this._normalizePath(target);
        path1 = this._normalizePath(path1);
        this.symlinks.set(path1, target);
        await this._sendWorkerEvent({
            type: "symlink",
            path: path1,
            target: target
...
const $86a3ba4eb3a17970$var$S_IFREG = 0o100000;
const $86a3ba4eb3a17970$var$S_IFDIR = 0o040000;
const $86a3ba4eb3a17970$var$S_IFLNK = 0o120000;
