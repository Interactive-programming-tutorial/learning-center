...
view session settings model =
    Html.div [ Attr.class "p-1" ]
        ...
        , Html.main_ [ Attr.class "lia-slide__content" ]
            [ Html.h1 [] [ Html.text "交互式编程教程-学习中心" ]
            ...
            , if List.isEmpty model.courses && model.initialized then
                Html.section [] <|
                    ...
                    , Html.p
                        ...
                        [ Html.text "如果你在这个列表中看不到任何课程，请点击下方链接返回官网首页，获取课程对应链接"
                        ]
                    , Html.u
                        []
                        [ Html.li []
                            [ Html.a
                                [ Attr.href "https://aiyc.top/", Attr.target "_blank" ]
                                [ Html.text "文档官网" ]
                            ]
                        , Html.li []
                            [ Html.a
                                [ Attr.href "https://github.com/Interactive-programming-tutorial/", Attr.target "_blank" ]
                                [ Html.text "github文档仓库" ]
                            ]
                        ]
                    , Html.br [] []
                    , Html.p
                        [ Attr.class "lia-paragraph" ]
                        [ Html.text "最后希望大家可以在该文档中学到知识！" ]
                    ]
...
inlines =
    List.map (Inline.view_inf Array.empty En False False Nothing Nothing >> Html.map (always NoOp))
